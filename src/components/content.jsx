      ...
      >
        ...
        <div className="lg:w-1/2 w-full lg:pr-12 mb-8 lg:mb-0">
          ...
          <div className="flex space-x-4">
            <LinkPreview
              url="https://www.instagram.com/hafizh.zikry/"
              target="_blank"
            ...
            >
              <svg
                ...
                strokeWidth="2 "
                className="w-6 h-6 -ml-4 text-gray-300 hover:text-purple-400 transition-transform transform hover:scale-110"
                viewBox="0 0 24 24"
              >
            ...
            <LinkPreview
              url="https://www.linkedin.com/in/muhammad-hafizh-zikry/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <LinkPreview
              url="https://github.com/hafizhzikry24/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
