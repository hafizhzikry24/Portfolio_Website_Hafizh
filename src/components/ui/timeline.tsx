      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#F3F4F6] flex items-center justify-center ">
...
<h3 className="hidden md:block text-xl md:pl-20 font-semibold text-[#1d377f]">
  {item.title}
            ...
            <div className="relative pl-20 pr-8 md:pl-4 w-full">
              <h3 className="md:hidden block text-xl mb-2 text-left font-semibold text-neutral-600 ">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
