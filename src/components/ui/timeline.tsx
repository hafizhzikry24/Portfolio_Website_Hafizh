...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-gray-950 py-20 font-sans md:px-10" id="experience"
      ref={containerRef} 
    >
  ...
  <div className="h-4 w-4 rounded-full bg-[#120f1a] border border-[#A78BFA] dark:border-[#A78BFA] p-2" />
</div>
<h3 className="hidden md:block text-xl md:pl-20 font-semibold text-neutral-300">
  {item.title}
</h3>
            </div>
