...
export default function HowItWorks({
  ...
  // Beyond the 5 positions the original design ships with, scale the pinned
  // track so extra steps (and any custom `stepPositions` supplied for them)
  // get room instead of overlapping past a flat 1130px ceiling.
  else height = 1130 + (data.length - 5) * 220;
