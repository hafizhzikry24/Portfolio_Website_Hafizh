  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p className="text-neutral-500 dark:text-neutral-200 text-xs md:text-base font-normal mb-6">
            Aug 2024 - Nov 2024
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs text-justify md:text-base font-normal mb-8 sm:mb-16">
            {language === "en"
